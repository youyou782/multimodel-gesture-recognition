...
import RSS_model as rss


os.environ["KMP_DUPLICATE_LIB_OK"]="TRUE"
# config log
logging.basicConfig(filename='log/V4_training_bs64_epo100_layer2_01.log', level=logging.INFO,
...
net_clone = rss.LSTMModel().to(device)
net_clone.load_state_dict(torch.load("parameter/RSS_LSTM2_parameter.pt"))

criterion = nn.CrossEntropyLoss()
optimizer = optim.Adam(net_clone.parameters(), lr=0.0005)  # Adjust learning rate if necessary
...
torch.save(net_clone.state_dict(), "parameter/RSS_LSTM2_parameter_02.pt")
