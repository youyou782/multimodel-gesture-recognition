...
if __name__ == "__main__":
    ...
    folder_path = os.path.join(os.path.dirname(script_path), "../DataSet_processed/RSS_v4/RSS_v4")
    ...
    np.save(os.path.join(os.path.dirname(script_path), 'data/v4_RSS_data.npy'), time_series)
    np.save(os.path.join(os.path.dirname(script_path), 'data/v4_RSS_labels.npy'), labels)